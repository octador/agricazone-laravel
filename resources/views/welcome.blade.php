        ...
        <nav class="">
            <div class="containernav">
                <div class="containerlogo">
                    <a href="{{ url('/dashboard') }}"><img src="{{ asset('images/logo_agricazone.png') }}" alt="logo agricazone" class="hover:text-gray-200"></a>
                </div>
                <div class="containeritems">

                    @if (Route::has('login'))
                    @auth
                    <a href="{{ url('/dashboard') }}" class="itemhome">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="fffff" class="bi bi-house-door" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('login') }}" class="itemconnexion">
                        <div class="itemclick">
                            <svg xmlns="http://www.w3.org/2000/svg" wdth="30" height="30" fill="currentColor" class="bi bi-person-circle mr-2" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('register') }}" class="iteminscription">
                        <div class="itemclick">
                            ...
                            " fill="currentColor" class="bi bi-person-vcard mr-2" viewBox="0 0 16 16">
